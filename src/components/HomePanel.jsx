      ...
      <div className="relative h-full flex flex-col md:flex-row items-center justify-center p-4 md:p-8">
        ...
        <div className="md:w-1/2 p-4 md:p-8">
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <button className="font-comic text-xl bg-comic-red text-white border-4 border-black px-6 py-3 shadow-comic-sm hover:shadow-comic-lg hover:scale-105 transition-all uppercase tracking-wider">
              START ADVENTURE!
            </button>
            <button className="font-comic text-xl bg-comic-blue text-white border-4 border-black px-6 py-3 shadow-comic-sm hover:shadow-comic-lg hover:scale-105 transition-all uppercase tracking-wider">
              VIEW MISSIONS
            </button>
          </div>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center items-center p-4">
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
            ...
            <div className="relative z-10 w-full h-full">
              <img
                src="/mascot2.png"  // Your hero mascot image
                alt="Mascot Hero"
